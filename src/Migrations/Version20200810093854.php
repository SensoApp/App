...
final class Version20200810093854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client_contract CHANGE clientname_id clientname_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE endDate endDate DATE DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE vat vat DOUBLE PRECISION DEFAULT NULL, CHANGE active active TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE citizenship_details CHANGE contact_id contact_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE client_contract CHANGE clientname_id clientname_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE endDate endDate DATE DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE vat vat DOUBLE PRECISION DEFAULT \'NULL\', CHANGE active active TINYINT(1) DEFAULT \'NULL\'');
