 ...
 */
final class Version20220823005955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client_contract CHANGE clientname_id clientname_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE endDate endDate DATE DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE vat vat DOUBLE PRECISION DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD revolut_account_id VARCHAR(255) DEFAULT NULL, CHANGE contact_id contact_id INT DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE invoice invoice VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE reset_token reset_token VARCHAR(255) DEFAULT NULL');
    }
