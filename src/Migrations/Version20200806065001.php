 ...
 */
final class Version20200806065001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client_contract ADD active TINYINT(1) DEFAULT NULL, CHANGE clientname_id clientname_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE endDate endDate DATE DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE vat vat DOUBLE PRECISION DEFAULT NULL');
